...
export DANUS_NODE="\$DANUS_ROOT/runtime/node22/bin/node"
export DANUS_NODE_BIN="\$DANUS_ROOT/runtime/node22/bin"
export DANUS_CODEX_JS="\$DANUS_ROOT/${CODEX_JS#"$DANUS_ROOT/"}"
